...
/* ZADANIE 3
 * Bazując na rozwiązaniu Zadania 2 napisz program realizujący zadanie klient-serwer. 
 * Tym razem, za każdym razem gdy serwer zaakceptuje nowe połączenie utwórz nowy wątek dla tego połączenia.
 * Dodatkowo, każda ze stron po otrzymaniu wiadomości niech wypisze wiadomość „Otrzymałem wiadomość: treść wiadomości”.
 * Wiadomości wysyłane przez serwer powinny mieć kolor czerwony, a wiadomości wysyłane przez klienta powinny mieć kolor zielony.
 */
namespace lab1iozad3
{
    class Program
    { 
